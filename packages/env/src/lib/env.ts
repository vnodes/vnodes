...
export class Env {
  ...
  get DB_POOL_CONNECTION_TIMEOUT_MILLIS_OR_THROW() {
    return this.orThrow(Env.DB_POOL_CONNECTION_TIMEOUT_MILLIS, this.DB_POOL_CONNECTION_TIMEOUT_MILLIS);
  }
  ...
  protected orDefault<T extends string | number>(_key: string, value: T | undefined, defaultValue: string | number): T {
    if (value === undefined) {
  ...
  get DB_MIGRATIONS_PATH_OR_DEFAULT() {
    return this.orDefault(Env.DB_MIGRATIONS_PATH, this.DB_MIGRATIONS_PATH, Env.DEFAULT_DB_MIGRATIONS_PATH);
  }
  get DB_PRISMA_SCHEMA_PATH_OR_DEFAULT() {
    return this.orDefault(Env.DB_PRISMA_SCHEMA_PATH, this.DB_PRISMA_SCHEMA_PATH, Env.DEFAULT_DB_PRISMA_SCHEMA_PATH);
  }
  ...
  get DB_POOL_IDLE_TIMEOUT_MILLIS_OR_DEFAULT() {
    return this.orDefault(Env.DB_POOL_IDLE_TIMEOUT_MILLIS, this.DB_POOL_IDLE_TIMEOUT_MILLIS, Env.DEFAULT_DB_POOL_IDLE_TIMEOUT_MILLIS);
  }
  get DB_POOL_MAX_USES_OR_DEFAULT() {
    return this.orDefault(Env.DB_POOL_MAX_USES, this.DB_POOL_MAX_USES, Env.DEFAULT_DB_POOL_MAX_USES);
  }
  get DB_POOL_STATEMENT_TIMEOUT_OR_DEFAULT() {
    return this.orDefault(Env.DB_POOL_STATEMENT_TIMEOUT, this.DB_POOL_STATEMENT_TIMEOUT, Env.DEFAULT_DB_POOL_STATEMENT_TIMEOUT);
  }
  get DB_POOL_QUERY_TIMEOUT_OR_DEFAULT() {
    return this.orDefault(Env.DB_POOL_QUERY_TIMEOUT, this.DB_POOL_QUERY_TIMEOUT, Env.DEFAULT_DB_POOL_QUERY_TIMEOUT);
  }
  get DB_POOL_LOCK_TIMEOUT_OR_DEFAULT() {
    return this.orDefault(Env.DB_POOL_LOCK_TIMEOUT, this.DB_POOL_LOCK_TIMEOUT, Env.DEFAULT_DB_POOL_LOCK_TIMEOUT);
  }
}
