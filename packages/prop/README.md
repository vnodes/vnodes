![Npm version](https://img.shields.io/npm/v/@vnodes/prop)
![Npm downloads](https://img.shields.io/npm/dm/@vnodes/prop)
![Build Status](https://img.shields.io/github/actions/workflow/status/vnodes/vnodes/ci.yml)
![Bundle size](https://img.shields.io/bundlephobia/min/@vnodes/prop)

<p align="center">
  <img   srcset="./assets/favicon.png, https://vnodes.github.io/packages/prop/assets/favicon.png" alt="Logo"  width="200" height="200" style="border-radius: 100%"/>
</p>

## @vnodes/prop

Data transfer object property decorator

## Installation

```bash
pnpm add -D @vnodes/prop
```
