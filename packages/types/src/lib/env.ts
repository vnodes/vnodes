...
export class Env {
  ...
  static readonly DB_POOL_CONNECTION_TIMEOUT_MILLIS =
  ...
  readonly DB_POOL_CONNECTION_TIMEOUT_MILLIS?: number;
  readonly DB_POOL_IDLE_TIMEOUT_MILLIS?: number;
  readonly DB_POOL_MAX_USES?: number;
  readonly DB_POOL_STATEMENT_TIMEOUT?: number;
  readonly DB_POOL_QUERY_TIMEOUT?: number;
  readonly DB_POOL_LOCK_TIMEOUT?: number;
