...
export class BaseContactService<
    CreateInput extends P.ContactCreateInput = P.ContactCreateInput,
    UpdateInput extends P.ContactUpdateInput = P.ContactUpdateInput,
    QueryInput extends QueryMany<P.ContactScalarFieldEnum> = QueryMany<P.ContactScalarFieldEnum>,
> {
    ...
    async findOneByUuid(uuid: string) {
        return await this.repo.findUnique({ where: { uuid: uuid } });
    }
    ...
    async updateOneByUuid(uuid: string, data: UpdateInput) {
        return await this.repo.update({ where: { uuid: uuid }, data });
    }
    async deleteOneById(id: string) {
        return await this.repo.delete({ where: { id: +id } });
    }
    async deleteOneByUuid(uuid: string) {
        return await this.repo.delete({ where: { uuid: uuid } });
    }
    ...
    async softDeleteOneByUuid(uuid: string) {
        return await this.repo.update({ where: { uuid: uuid }, data: { deletedAt: new Date() } });
    }
}

export class BaseContactController<
    CreateInput extends P.ContactCreateInput = P.ContactCreateInput,
    UpdateInput extends P.ContactUpdateInput = P.ContactUpdateInput,
    QueryInput extends QueryMany<P.ContactScalarFieldEnum> = QueryMany<P.ContactScalarFieldEnum>,
> {
...
export class BaseEmailService<
    CreateInput extends P.EmailCreateInput = P.EmailCreateInput,
    UpdateInput extends P.EmailUpdateInput = P.EmailUpdateInput,
    QueryInput extends QueryMany<P.EmailScalarFieldEnum> = QueryMany<P.EmailScalarFieldEnum>,
> {
...
export class BaseEmailController<
    CreateInput extends P.EmailCreateInput = P.EmailCreateInput,
    UpdateInput extends P.EmailUpdateInput = P.EmailUpdateInput,
    QueryInput extends QueryMany<P.EmailScalarFieldEnum> = QueryMany<P.EmailScalarFieldEnum>,
> {
...
export class BasePhoneService<
    CreateInput extends P.PhoneCreateInput = P.PhoneCreateInput,
    UpdateInput extends P.PhoneUpdateInput = P.PhoneUpdateInput,
    QueryInput extends QueryMany<P.PhoneScalarFieldEnum> = QueryMany<P.PhoneScalarFieldEnum>,
> {
...
export class BasePhoneController<
    CreateInput extends P.PhoneCreateInput = P.PhoneCreateInput,
    UpdateInput extends P.PhoneUpdateInput = P.PhoneUpdateInput,
    QueryInput extends QueryMany<P.PhoneScalarFieldEnum> = QueryMany<P.PhoneScalarFieldEnum>,
> {
...
export class BaseAddressService<
    CreateInput extends P.AddressCreateInput = P.AddressCreateInput,
    UpdateInput extends P.AddressUpdateInput = P.AddressUpdateInput,
    QueryInput extends QueryMany<P.AddressScalarFieldEnum> = QueryMany<P.AddressScalarFieldEnum>,
> {
