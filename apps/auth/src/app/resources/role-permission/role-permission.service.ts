...
import type { RolePermissionCreateDto, RolePermissionQueryDto, RolePermissionUpdateDto } from './dtos/index.js';
import { RolePermissionQueryService } from './role-permission-query.service.js';

@Injectable()
export class RolePermissionService implements ResourceOperations {
    constructor(
        @InjectDelegate('rolePermission') protected readonly repo: P.Prisma.RolePermissionDelegate,
...
async validateUniques(data: Partial<P.Prisma.RolePermissionModel>, id?: number) {
    ...
    async findByIdOrThrow(id: number) {
        try {
            ...
            throw new NotFoundException('A RolePermission with the id is not found');
        }
    }
